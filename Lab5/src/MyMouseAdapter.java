			...
			if (myPanel.mouseDownGridX == -1 || myPanel.mouseDownGridY == -1) {
				...
				if ((gridX == -1) || (gridY == -1)) {
					...
					if (myPanel.mouseDownGridX != gridX || myPanel.mouseDownGridY != gridY) {
						...
						//On the grid
						if(myPanel.isMine(gridX, gridY) && myPanel.getColor(gridX,gridY) != Color.RED) {
							//If square is a mine and hasn't been flagged, user lost
							myPanel.minePressed();
						} else if(myPanel.getColor(gridX,gridY) != Color.RED && myPanel.getColor(gridX,gridY) != Color.BLACK) {
							//Paint the panel if it hasn't been flagged or revealed to be a mine
				...
				if ((gridX == -1) || (gridY == -1)) {
					...
					if ((myPanel.mouseDownGridX != gridX) || (myPanel.mouseDownGridY != gridY)) {
						...
						if(myPanel.getColor(gridX,gridY) == Color.RED) {
							...
							myPanel.removeFlag();
						} else if(myPanel.getColor(gridX,gridY) != Color.GRAY && myPanel.getColor(gridX,gridY) != Color.BLACK && myPanel.getFlags() < myPanel.getMines()){
							//Paint the tile red as long as it hasn't been uncovered or shown to be a mine
